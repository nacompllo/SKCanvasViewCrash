...
using MauiEasing = Microsoft.Maui.Easing;

namespace SKCanvasViewCrash.Controls;
...
public partial class CircularProgressBar : ContentView
{
    ...
    private void CanvasPaintSurface(object sender, SKPaintSurfaceEventArgs args)
    {
        ...
        float delta = ((float)Progress - _currentProgress) * (float)MauiEasing.CubicInOut.Ease(_easing);
    ...
    /// <summary>
    /// Converts .NET MAUI units into pixels.
    /// https://stackoverflow.com/a/63615455/6499748
    /// </summary>
    /// <param name="value">.NET MAUI units.</param>
